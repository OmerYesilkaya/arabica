  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        [
          { ar: 'كَانَ' },
          { ar: 'الْإِنْسَانُ', note: 'ḍamma' },
          { ar: 'عَجُولًا' },
          'fatḥa (tanwīn fatḥ)',
        ],
        [{ ar: 'أَمْسَى' }, { ar: 'الْجَوُّ', note: 'ḍamma' }, { ar: 'بَارِدًا' }, 'fatḥa'],
        [
          { ar: 'أَصْبَحَ' },
          { ar: 'فُؤَادُ', note: 'ḍamma; muḍāf to أُمِّ' },
          { ar: 'فَارِغًا' },
          'fatḥa',
        ],
        [{ ar: 'أَضْحَى' }, { ar: 'الطَّالِبُ', note: 'ḍamma' }, { ar: 'مُجْتَهِدًا' }, 'fatḥa'],
        [
          { ar: 'ظَلَّ' },
          { ar: 'وَجْهُهُ', note: 'ḍamma; هُ is muḍāf ilayhi' },
          { ar: 'مُسْوَدًّا' },
          'fatḥa',
        ],
        [{ ar: 'بَاتَ' }, { ar: 'الْحَارِسُ', note: 'ḍamma' }, { ar: 'سَاهِرًا' }, 'fatḥa'],
        [{ ar: 'صَارَ' }, { ar: 'الطِّينُ', note: 'ḍamma' }, { ar: 'خَزَفًا' }, 'fatḥa'],
        [
          { ar: 'لَيْسَ' },
          { ar: 'الذَّكَرُ', note: 'ḍamma' },
          { ar: 'كَالْأُنْثَى', note: 'shibh al-jumla' },
          'in maḥall naṣb (no visible ending)',
        ],
        [
          { ar: 'مَا زَالَ' },
          { ar: 'ـُونَ', note: 'wāw al-jamāʿa, in maḥall rafʿ' },
          { ar: 'مُخْتَلِفِينَ' },
          'yāʾ (sound masculine plural)',
        ],
        [{ ar: 'مَا انْفَكَّ' }, { ar: 'زَيْدٌ', note: 'ḍamma' }, { ar: 'صَائِمًا' }, 'fatḥa'],
        [
          { ar: 'مَا فَتِئَ' },
          { ar: 'الْمُؤْمِنُ', note: 'ḍamma' },
          { ar: 'ذَاكِرًا', note: 'رَبَّهُ is its mafʿūl' },
          'fatḥa',
        ],
        [
          { ar: 'مَا بَرِحَ' },
          { ar: 'ـنَا', note: 'the نَ of نَبْرَحُ, in maḥall rafʿ' },
          { ar: 'عَاكِفِينَ' },
          'yāʾ (sound masculine plural)',
        ],
        [
          { ar: 'مَا دَامَ' },
          { ar: 'ـتُ', note: 'tāʾ al-fāʿil, in maḥall rafʿ' },
          { ar: 'حَيًّا' },
          'fatḥa',
        ],
      ],
    ...
    },
    {
      ...
      rows: [
        [
          ...
          { ar: 'زَيْدٌ', note: 'mubtadaʾ, marfūʿ: ḍamma' },
          { ar: 'قَائِمٌ', note: 'khabar, marfūʿ: ḍamma' },
          'plain nominal sentence: both parts marfūʿ',
        ],
        [
          { ar: 'كَانَ زَيْدٌ قَائِمًا', note: 'Zayd was standing / Zeyd ayakta idi' },
          { ar: 'زَيْدٌ', note: 'ism kāna, marfūʿ: ḍamma' },
          { ar: 'قَائِمًا', note: 'khabar kāna, manṣūb: fatḥa' },
          'kāna raises the ism, puts the khabar into naṣb',
        ],
        [
          { ar: 'لَيْسَ عَمْرٌو شَاخِصًا', note: 'ʿAmr is not going away / Amr gidici değildir' },
          { ar: 'عَمْرٌو', note: 'ism laysa, marfūʿ: ḍamma' },
          { ar: 'شَاخِصًا', note: 'khabar laysa, manṣūb: fatḥa' },
