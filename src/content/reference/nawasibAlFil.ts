  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ...
        [
          { ar: 'اَلْمُعْتَلُّ الْآخِرِ بِالْوَاوِ أَوِ الْيَاءِ', footnote: 'ends in wāw or yāʾ / vav veya ya ile biten' },
          { ar: 'ـُ', footnote: 'implied ḍamma' },
          { ar: 'ـَ', footnote: 'fatḥa, visible' },
          { ar: 'أَنْ يَأْتِيَ يَوْمٌ', source: 'Qur’an 2:254' },
        ],
        [
          { ar: 'اَلْمُعْتَلُّ الْآخِرِ بِالْأَلِفِ', footnote: 'ends in alif / elif ile biten' },
          { ar: 'ـُ', footnote: 'implied ḍamma' },
          { ar: 'ـَ', footnote: 'fatḥa, not visible' },
    ...
    },
    {
      ...
      rows: [
        [
          { ar: 'هُمَا', footnote: 'they two (m) / o ikisi (eril)' },
          { ar: 'يَفْعَلَانِ' },
          { ar: 'يَفْعَلَا' },
          '—',
        ],
        [
          { ar: 'هُمَا', footnote: 'they two (f) / o ikisi (dişil)' },
          { ar: 'تَفْعَلَانِ' },
          { ar: 'تَفْعَلَا' },
          '—',
        ],
        [
          { ar: 'أَنْتُمَا', footnote: 'you two / siz ikiniz' },
          { ar: 'تَفْعَلَانِ' },
          { ar: 'تَفْعَلَا' },
          { ar: 'إِلَّا أَنْ تَكُونَا مَلَكَيْنِ', source: 'Qur’an 7:20' },
        ],
        [
          { ar: 'هُمْ', footnote: 'they (m pl) / onlar (eril çoğul)' },
          { ar: 'يَفْعَلُونَ' },
          { ar: 'يَفْعَلُوا' },
          { ar: 'فَيَمُوتُوا', source: 'Qur’an 35:36' },
        ],
        [
          { ar: 'أَنْتُمْ', footnote: 'you (m pl) / siz (eril çoğul)' },
          { ar: 'تَفْعَلُونَ' },
          { ar: 'تَفْعَلُوا' },
          { ar: 'وَأَنْ تَصُومُوا', source: 'Qur’an 2:184' },
        ],
        [
          { ar: 'أَنْتِ', footnote: 'you (f sg) / sen (dişil)' },
          { ar: 'تَفْعَلِينَ' },
          { ar: 'تَفْعَلِي' },
          '—',
        ],
